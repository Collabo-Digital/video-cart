...
export const OnboardingSetup = ({
  ...
  const firstIncompleteId = items.find((item) => !item.complete)?.id ?? items[0]?.id;
  const [expanded, setExpanded] = useState(firstIncompleteId);
          ...
          <InlineStack align='space-between' blockAlign='center'>
            ...
            <ButtonGroup gap='tight' noWrap>
              ...
              <Button
                ...
                onClick={() => {
                  setIsGuideOpen((prev) => {
                    if (!prev) setExpanded(items.find((item) => !item.complete)?.id ?? items[0]?.id);
                    return !prev;
                  });
                }}
        ...
        <InlineStack gap='200' align='start' blockAlign='start' wrap={false}>
          ...
          >
            <BlockStack gap='300'>
              ...
              <Collapsible open={expanded} id={collapsibleId}>
